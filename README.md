...
垂直切片架构（Vertical Slice Architecture），按特性组织代码，每个切片自成一体，正成为 AI 友好的架构模式，因为它最大化了上下文隔离。AI 工具可以理解并修改一个自包含的特性，而无需了解整个代码库。相比之下，AI 很难应对单体架构，相同术语出现在几十个地方，依赖链超出上下文窗口限制。

## 约束

以严格的**强制约束**限制AI写出符合VSA规范的代码，同时确保代码质量。
